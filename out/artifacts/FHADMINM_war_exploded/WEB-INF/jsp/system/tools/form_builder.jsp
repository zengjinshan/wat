...
<body class="gray-bg">
	...
	function getUeditorFormHtml(html,msg,isgx){
		var arryUe = html.split('<div class="uecss"></div>');
		if(arryUe.length == 3){
			var uejscode = "<script id=\"editor\" type=\"text/plain\" style=\"width:96%;height:200px;\"><\/script>";
			if(msg == '1'){
				if(isgx == '2'){
					ueditorHtml = arryUe[1];
					return arryUe[0] + '<div class="uecss"></div>' + uejscode + '<div class="uecss"></div>' + arryUe[2];
				}else{
					return arryUe[0] + '<div class="uecss"></div>' + ueditorHtml + '<div class="uecss"></div>' + arryUe[2];
				}
			}else{
	...
	function getSelectFormHtml(html,msg,isgx){
		var arrySe = html.split('<div class="selcss"></div>');
		if(arrySe.length == 3){
			...
			if(msg == '1'){
				if(isgx == '2'){
					return arrySe[0] + '<div class="selcss"></div>' + selectcode + '<div class="selcss"></div>' + arrySe[2];
				}else{
					selectHtml = arrySe[1];
					return html;
				}
	...
	function getFileFormHtml(html,msg,isgx){
		var arryFile = html.split('<div class="filecss"></div>');
		if(arryFile.length == 3){
			var filecode = "<input type=\"file\" id=\"tp\" name=\"tp\" />";
			if(msg == '1'){
				if(isgx == '2'){
					fileHtml = arryFile[1];
					return arryFile[0] + '<div class="filecss"></div>' + filecode + '<div class="filecss"></div>' + arryFile[2];
				}else{
					return arryFile[0] + '<div class="filecss"></div>' + fileHtml + '<div class="filecss"></div>' + arryFile[2];
				};
			}else{
