...
import com.fh.framewrok.util.AppUtil;
import com.fh.framewrok.util.DateUtil;
import com.fh.framewrok.util.DelAllFile;
import com.fh.framewrok.util.FileDownload;
import com.fh.framewrok.util.FileZip;
import com.fh.framewrok.util.Freemarker;
import com.fh.framewrok.util.Jurisdiction;
import com.fh.framewrok.util.PageData;
import com.fh.framewrok.util.PathUtil;
...
public class CreateCodeController extends BaseController {
	...
	public void proCode(HttpServletResponse response) throws Exception{
		...
		/*生成SQL脚本*/
		Freemarker.printFile("mysql_SQL_Template.ftl", root, "mysql_scripts/"+tabletop+objectName.toUpperCase()+".sql", filePath, ftlPath);
		Freemarker.printFile("oracle_SQL_Template.ftl", root, "oracle_scripts/"+tabletop+objectName.toUpperCase()+".sql", filePath, ftlPath);
		Freemarker.printFile("sqlserver_SQL_Template.ftl", root, "sqlserver_scripts/"+tabletop+objectName.toUpperCase()+".sql", filePath, ftlPath);
		...
		/*生成说明文档*/
		Freemarker.printFile("docTemplate.ftl", root, "DeploymentDoc.doc", filePath, ftlPath);
